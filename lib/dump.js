...
var stringifyPrimitiveWrapper = function (acc, x, config) {
...
var stringifyArray = function (acc, x, config) {
...
var stringifyObject = function (acc, x, config) {
    var tname = typeName(this.node);
...
var handlers = {
    ...
    'string': function (acc, x, config) {
        acc.push(JSON.stringify(x));
    },
    'boolean': function (acc, x, config) {
        acc.push(JSON.stringify(x));
    },
    'number': stringifyNumber,
    'RegExp': function (acc, x, config) {
        acc.push(x.toString());
    },
